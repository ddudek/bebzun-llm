...
from bebzun_llm.static_analysis.model.model import ClassStructure, ClassStructureDependency, ClassStructureMethod
from bebzun_llm.static_analysis.parsers.base_parser import BaseParser
