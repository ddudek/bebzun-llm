...
from bebzun_llm.knowledge.model import ClassDescriptionExtended
...
from bebzun_llm.core.context.build_context_result import BuildContextQueriesLLMResult, BuildContextGetFilesLLMResult, BuildContextStep3, AffectedArea
from bebzun_llm.core.search.search import KnowledgeSearch
from bebzun_llm.core.search.search_result import SearchResult
from bebzun_llm.interact.memory.memory import Memory, MemoryItemClassSummary
